...
def to_update():
    try:
        ...
        def confirm():
            ...
            show()  
        b_confirm = Button(frame_down, text="Confirm", width=10, height=1, bg=co2, font=('Ivy 8 bold'),command=confirm)  
...
app_name =Label(frame_up, text="Callorganizer", height=1, font=('Verdana 17 bold'), bg=co2, fg=co0)
